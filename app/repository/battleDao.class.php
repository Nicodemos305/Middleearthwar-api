...
class BattleDao extends DataSource{
	...
	function battleBegin(Battle $battle){
  		$sql = "insert into battle values(uuid(),'".$battle->getPlayerOne()."','".$battle->getPlayerTwo()."',".$battle->getHpOne().",".$battle->getHpTwo().",'RUNING',0)";
	...
	function searchEnemy($idHero){
		$sql = "select * from hero where uuid <> '".$idHero."'";
